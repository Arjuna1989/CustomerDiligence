...
$(function ($) {
   ...
   $('.navbar-nav li').on('click', function () {
      $('.navbar-nav li').find('.nav-link').removeClass('active');
      $(this).find('.nav-link').addClass('active');
   });

   $('.tw-dropdown-menu li').on('click', function () {
      $('.tw-dropdown-menu li').find('a').removeClass('active');
   ...
   $(window).on('scroll', function () {
      if ($(window).scrollTop() > 400) {
         $('.tw-head').addClass('navbar-fixed');
      } 
      else {
         $('.tw-head').removeClass('navbar-fixed');
      }
      if($(window).scrollTop() < 400) {
         setTimeout(() => {
